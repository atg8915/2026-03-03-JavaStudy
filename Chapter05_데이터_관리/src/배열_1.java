...
public class 배열_1 {
	...
	public static void main(String[] args) {
		...
		System.out.print("2번째 학생의 국어 점수: ");
		kor2 = sc.nextInt();
		
		System.out.print("2번째 학생의 영어 점수: ");
		eng2 = sc.nextInt();
		
		System.out.print("2번째 학생의 수학 점수: ");
		math2 = sc.nextInt();
			
		total2 = kor2 + eng2 + math2;
		avg2 = total2/3.0;
		
		System.out.print("3번째 학생의 국어 점수: ");
		kor3 = sc.nextInt();
		
		System.out.print("3번째 학생의 영어 점수: ");
		eng3 = sc.nextInt();
		
		System.out.print("3번째 학생의 수학 점수: ");
		math3 = sc.nextInt();
